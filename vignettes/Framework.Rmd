...
Im weiteren Verlauf wird statt von Objekten auch der Begriff der Klasse benutzt.
...
Diese kann explizit per `connect()` geöffnet oder `disconnect()` geschlossen werden. Weitere Details zum Verhalten der Connection Klasse werden nächsten Abschnitt näher erläutert.
Die Methoden zum steuern der der Verbindung geben jeweils einen boolean Wert als Indikator zurück.
